            ...
            <div class="twelve wide column">
                ...
                <?php
                  ...
                  if(isset($_POST['submit_donation'])) {
                    // Check if the 'program' key exists in $_POST
                    if (isset($_POST['program'])) {
                        $program = $_POST['program'];
                    } else {
                        $program = null; // Or handle this as an error
                    }
                    ...
                    // Add a condition to ensure program is selected
                    if ($program) {
                        ...
                        echo "<script> alert('Please select a program to sponsor'); </script>";
                    }
